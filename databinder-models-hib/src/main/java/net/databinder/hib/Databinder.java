...
public class Databinder {
	 ...
	 * @see HibernateApplication
	 */
	public static SessionFactory getHibernateSessionFactory(final Object key) {
	 ...
	 */
	public static boolean hasBoundSession(final Object key) {
	 ...
	 */
	private static void dataSessionRequested(final Object key) {
	 ...
	 * @see SessionUnit
	 */
	public static Object ensureSession(final SessionUnit unit, final Object key) {
		dataSessionRequested(key);
		final SessionFactory sf = getHibernateSessionFactory(key);
